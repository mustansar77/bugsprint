...
const menu = [
  ...
  { name: "Assigned Bugs", path: "/dashboard/seller/assigned-bugs" },
  { name: "Completed Bugs", path: "/dashboard/seller/completed-bugs" },
//   { name: "Wallet", path: "/dashboard/seller/wallet" },
  { name: "Withdraw", path: "/dashboard/seller/withdraw" },
  { name: "Support", path: "/dashboard/seller/support" },
];
