...
import registerIllustration from "../../../../public/pic-2.png"; // Replace with your animated image
  ...
  return (
    <section className="min-h-screen bg-white flex items-center justify-center py-28 sm:py-12 px-4">
      ...
      <div className="bg-secondary rounded-3xl shadow-xl w-full max-w-6xl flex flex-col md:flex-row overflow-hidden">
        ...
        {/* Left Info Section */}
        <div className="md:w-1/2 p-8 sm:p-12 flex flex-col justify-center text-white text-center md:text-left">
          <h1 className="text-3xl sm:text-4xl font-bold mb-4 text-center">Welcome to BugSprint</h1>
        ...
        <div className="md:w-1/2 bg-[#F4F7FA] p-6 sm:p-12 flex flex-col justify-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-secondary mb-2 text-center md:text-left">Create Account</h2>
          <p className="text-gray-500 mb-6 text-center md:text-left text-sm sm:text-base">Start your journey with BugSprint today.</p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-6">
            ...
            <button className="flex-1 flex items-center justify-center px-4 py-2 bg-blue-600 text-white rounded-lg shadow hover:bg-blue-700 transition">
              <FaFacebookF className="mr-2" />Register With Facebook
            </button>
          </div>
